      ...
      <div className="mx-auto max-w-7xl">
        ...
        <div className="grid gap-12 border-b border-white/10 pb-16 md:grid-cols-3 md:gap-10">
          ...
          <div className="flex items-end justify-center gap-6 opacity-70 md:-translate-x-10">
            {/* Pitcher with handle */}
            <svg viewBox="0 0 100 150" fill="currentColor" className="h-16 w-auto text-[#dfd0c0] md:h-24" aria-hidden="true">
            ...
            {/* Wide bowl */}
            <svg viewBox="0 0 120 100" fill="currentColor" className="h-12 w-auto text-[#dfd0c0] md:h-16" aria-hidden="true">
            ...
            <svg viewBox="0 0 100 160" fill="currentColor" className="h-20 w-auto text-[#dfd0c0] md:h-28" aria-hidden="true">
            ...
            {/* Small squat pot */}
            <svg viewBox="0 0 100 100" fill="currentColor" className="h-10 w-auto text-[#dfd0c0] md:h-14" aria-hidden="true">
