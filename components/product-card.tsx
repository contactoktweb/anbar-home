...
export function ProductCard({ product }: ProductCardProps) {
  ...
  return (
    <div className="group flex flex-col cursor-pointer">
      <div className="relative mb-4 aspect-square overflow-hidden bg-white flex items-center justify-center p-4">
        {/* Sale badge */}
      ...
      <div className="flex flex-col space-y-1">
        ...
        <h3 className="text-[15px] font-medium leading-snug text-neutral-800 transition-colors group-hover:text-camel min-h-[1.2em]">
          {product.name || '\u00A0'}
        </h3>
