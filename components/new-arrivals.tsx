...
export function NewArrivals({ products = [] }: { products?: any[] }) {
  ...
  useEffect(() => {
    if (currentIndex >= originalProducts.length * 2) {
      const timeoutId = setTimeout(() => {
        setIsTransitioning(false)
        setCurrentIndex(currentIndex - originalProducts.length) 
      }, 800)
  ...
  }, [currentIndex, originalProducts.length])
        ...
        <div className="flex flex-col md:flex-row justify-between items-end gap-6">
          <div className="max-w-xl">
            ...
            <p className="text-neutral-500 font-light leading-relaxed">
              Descubre nuestras más recientes incorporaciones. Diseños pensados para renovar la energía de tu hogar.
            </p>
          </div>
