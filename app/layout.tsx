        ...
        <StoreProvider>
          ...
          <Script id="meta-pixel" strategy="afterInteractive">
            {`
              ...
              fbq('init', '${process.env.NEXT_PUBLIC_META_PIXEL_ID || '1605719891129628'}');
              fbq('track', 'PageView');
            `}
          </Script>
          <noscript>
            <img
              ...
              width="1"
              style={{ display: 'none' }}
              src={`https://www.facebook.com/tr?id=${process.env.NEXT_PUBLIC_META_PIXEL_ID || '1605719891129628'}&ev=PageView&noscript=1`}
              alt=""
            />
          </noscript>
          {/* End Meta Pixel Code */}
